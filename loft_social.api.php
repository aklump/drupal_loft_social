 ...
 *
 * @param  array &$files An array of image file arrays with at least 'uri' key
 *                       of images for for this page.  These images will be
 *                       added to the page as multiple og:image and so forth as
 *                       appropriate.
 * @param  array $context
 *                       - path: The unaliased path
 *                       - node: If a node is associated with this page; same
 *                       as menu_get_object()
 ...
 *
 * Use this hook if caching the tags is not possible, such as if the metatag is
 * influence by a GET variable: loft_social_realtime_metatags_query_key
 *
 ...
 *
 * Allows modules to alter the default $path when no args sent to
 * loft_social_url().
 *
